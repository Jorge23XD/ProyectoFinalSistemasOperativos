...
> El proceso es  sencillo, desde la web de uNetbootin nos descargamos el software para crear nuestro USB maestro.
...
>  Si tu modelo es compatible con Ubuntu, aparecerá un icono con tu disco duro principal y al lado un disco USB, que será tu instalador de Ubuntu.

> Si vas a instalar Ubuntu en tu Mac, lo más seguro es que quieras conservar tu sistema principal.

>  A no ser que surgan problemas con OS X, pero no es posible qué se deba hacer ya que funciona bien. 
